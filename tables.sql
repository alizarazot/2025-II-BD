-- =============================================
-- ESQUEMA INMOBIX - MODELO COMPLETO PARA POSTGRESQL
-- =============================================

-- Crear el esquema si no existe
CREATE SCHEMA IF NOT EXISTS INMOBIX;

-- Establecer el esquema como predeterminado para esta sesión (opcional)
-- SET search_path TO INMOBIX, public;
...
CREATE TABLE INMOBIX.CLIENT (
    ...
    FIRST_LASTNAME VARCHAR(15),
    SECOND_LASTNAME VARCHAR(15),
    EMAIL VARCHAR(100),
    PHONE VARCHAR(10),
    BIRTHDATE DATE,
...
COMMENT ON COLUMN INMOBIX.CLIENT.NUMBERDOCUMENT IS 'Relacionado con document type.';
COMMENT ON COLUMN INMOBIX.CLIENT.GRADE_DESCRIPTION IS 'Calificación de la inmobiliaria hacia el cliente.';
